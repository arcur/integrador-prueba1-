...
const { isAuth, isAdmin, isMainAdmin } = require('../middlewares/auth.middleware.js');
...
router.post('/pedidos/actualizar-estado/:id', adminController.actualizarEstadoPedido);
...
router.get('/productos/:id_producto/lotes/nuevo', adminController.mostrarFormularioLote);
...
router.get('/proveedores/editar/:id', adminController.mostrarFormularioProveedor);
...
router.post('/clientes/actualizar-estado/:id', adminController.actualizarEstadoCliente);

// --- GESTIÓN DE ADMINISTRADORES ---
router.get('/gestion-admins', isMainAdmin, adminController.mostrarGestionAdmins);
router.get('/gestion-admins/nuevo', isMainAdmin, adminController.mostrarFormularioAdmin);
router.post('/gestion-admins/nuevo', isMainAdmin, adminController.crearAdmin);
router.get('/gestion-admins/editar/:id', isMainAdmin, adminController.mostrarFormularioAdmin);
router.post('/gestion-admins/editar/:id', isMainAdmin, adminController.actualizarAdmin);
